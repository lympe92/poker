...
export class CardsService {
  ...
  startCards(players:number){
    
    for(let i=0;i<players*2;i++){
      this.playerCards.push(new card("",0,"",true,"assets/images/secret-card.png"));
    }
  }
  startgame(){

    this. cards=[{name:"A",cardId:1,shape:"clubs",available:true,img:"assets/images/a-clubs.png"},
    {name:"A",cardId:1,shape:"diamonds",available:true,img:"assets/images/a-diamonds.png"},
    {name:"A",cardId:1,shape:"hearts ",available:true,img:"assets/images/a-hearts.png"},
    {name:"A",cardId:1,shape:"spades ",available:true,img:"assets/images/a-spades.png"},       
    ...
    this.tableCards=[{name:"",cardId:0,shape:"",available:true,img:"assets/images/secret-card.png"},
    {name:"",cardId:0,shape:"",available:true,img:"assets/images/secret-card.png"},
    {name:"",cardId:0,shape:"",available:true,img:"assets/images/secret-card.png"},
    {name:"",cardId:0,shape:"",available:true,img:"assets/images/secret-card.png"},
    {name:"",cardId:0,shape:"",available:true,img:"assets/images/secret-card.png"}
    ];
